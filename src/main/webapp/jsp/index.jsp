...
<body onload="getTime()">
    ...
    <b><b id="time"></b>，${loginUser.userName}，欢迎使用信息管理系统</b>
    <a href="editUser.html">帐号设置</a>
    </div>

    <c:if test="${loginUser.lastLogin != null}">
        <div class="welinfo">
            <span><img src="images/time.png" alt="时间" /></span>
            <i>您上次登录的时间：${loginUser.lastLogin}</i> （不是您登录的？<a href="#">请点这里</a>）
        </div>
    </c:if>
